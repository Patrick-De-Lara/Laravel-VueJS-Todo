        ...
        <div class="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
            <main class="flex w-full max-w-[335px] flex-col-reverse overflow-hidden rounded-lg lg:max-w-4xl lg:flex-row">
                ...
                >
                    ...
                    <!-- Todo App Link -->
                    <div class="mb-4 p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg border border-green-200 dark:from-green-900/20 dark:to-emerald-900/20 dark:border-green-800">
                        <p class="text-sm font-medium text-gray-900 dark:text-gray-100 mb-2">📝 Todo Application</p>
                        <Link 
                            href="/todos" 
                            class="inline-flex items-center text-sm font-medium text-green-600 hover:text-green-800 dark:text-green-400 dark:hover:text-green-300 underline underline-offset-4"
                        >
                            Manage Your Todos →
                        </Link>
                    </div>
                    ...
                    <!-- Auth Links -->
                    <div class="mb-4 p-4 bg-gradient-to-r from-purple-50 to-blue-50 rounded-lg border border-purple-200 dark:from-purple-900/20 dark:to-blue-900/20 dark:border-purple-800">
                        <p class="text-sm font-medium text-gray-900 dark:text-gray-100 mb-3">🔐 Authentication</p>
                        <div class="flex gap-3">
                            <Link 
                                href="/login" 
                                class="flex-1 text-center px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 transition"
                            >
                                Login
                            </Link>
                            <Link 
                                href="/register" 
                                class="flex-1 text-center px-4 py-2 bg-purple-600 text-white text-sm font-medium rounded-lg hover:bg-purple-700 transition"
                            >
                                Register
                            </Link>
                        </div>
                    ...
                    <!-- Demo Link -->
                    <div class="mb-4 p-4 bg-blue-50 rounded-lg border border-blue-200 dark:bg-blue-900/20 dark:border-blue-800">
                        <p class="text-sm font-medium text-blue-900 dark:text-blue-100 mb-2">🚀 Practice Demo</p>
                        <Link 
                            href="/users" 
                            class="inline-flex items-center text-sm font-medium text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 underline underline-offset-4"
                        >
                            View Seeded Users List →
                        </Link>
                    </div>
